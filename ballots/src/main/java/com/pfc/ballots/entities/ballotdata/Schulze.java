...
public class Schulze {
	...
	public Schulze(List<String> options)
	{
	 ...
	 */
	public boolean calcularSchulze()
	{
		...
		{
			results=CalcSchulze.CalculateSchulze(options, votes);
			return true;
		}
	}
