...
import com.Calculo.CalcVotoAcumulativo;
/**
 * Brams entity that contains the information of specific information
 * for a acumulative voting ballot
 * 
...
public class VotoAcumulativo {
	...
	///////////////////////////////////////////// Constructors//////////////////////////////
	public VotoAcumulativo()
	{
		
	}
	public VotoAcumulativo(String nulltoinitialize)
	{
	...
	public VotoAcumulativo(List<String> options)
	{
	 ...
	 */
	public boolean calcularVotoAcumulativo()
	{
		...
		else
		{
			...
			this.results=CalcVotoAcumulativo.CalculateVotoAcumulativo(options, votes, winners);
			return true;
		}
	}
